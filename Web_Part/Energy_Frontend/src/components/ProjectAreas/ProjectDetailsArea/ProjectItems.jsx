...
const ProjectItem = ({ team }) => {
  ...
  useEffect(() => {
    ...
    return (
        <div className="card" style={{ backgroundColor: '#90CBF0', borderRadius: '10px', boxShadow: '0px 4px 12px rgba(0, 0, 0, 0.5)', padding: '15px',borderColor:"darkblue" }}>
            <div className="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <button type="button" className="abc" onClick={handleJoinTeam}>Join Team</button>
                </div>
            </div>
            <style>
            {
